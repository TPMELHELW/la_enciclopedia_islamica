...
import 'package:la_enciclopedia_islamica/features/non_muslim/presentation/screens/non_muslim_sub_topic_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class NonMuslimTopicsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<NonMuslimController>(
          init: NonMuslimController.instance,
          builder: (controller) {
            return controller.getCoursesState == StateType.loading
                ? const Center(
